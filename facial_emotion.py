...
Angry_dir= os.path.join(r'C:\Users\pavani\Downloads\happy\angry')

# Directory with Happy images
Happy_dir= os.path.join(r'C:\Users\pavani\Downloads\happy\happy')

# Directory with Neutral images
Neutral_dir = os.path.join(r'C:\Users\pavani\Downloads\happy\neutral')

# Directory with Sad images
Sad_dir = os.path.join(r'C:\Users\pavani\Downloads\happy\sad')

# Directory with Surprise images
Surprise_dir = os.path.join(r'C:\Users\pavani\Downloads\happy\surprise')
...
train_generator = train_datagen.flow_from_directory(r'C:\Users\pavani\Downloads\happy',  # This is the source directory for training images
